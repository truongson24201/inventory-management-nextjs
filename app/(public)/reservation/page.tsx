...
export default function page() {
    ...
    const fetchreservationsClient = async () => {
        try {
            showLoading();
            const { data } = await getReservation(date);
    ...
    return (
        <div className="flex flex-col gap-3 py-2 px-3 bg-gray-100 rounded-md shadow-lg">
            ...
            <p className="font-bold text-red-500">
                ...
                ${reservation.price.adultPrice.toLocaleString()}
            </p>
            <p className="font-bold text-red-500">
                <span className="">Child Price: </span>
                ${reservation.price.childPrice.toLocaleString()}
            </p>
            <p>
